...
($traceurRuntime.createClass)(NgNode, {
  ...
  hasClass: function(classes) {
    ...
    return classes.split(' ').reduce((function(state, className) {
      return state && !!$__0._classes.cache[className];
    }), true);
    return this;
  },
  ...
  toggleClass: function(classes) {
    ...
    classes.split(' ').forEach((function(className) {
      ...
      if (classCondition === null) {
        classCondition = !$__0._classes.cache[className];
      }
      $__0._classes.cache[className] = classCondition;
      $__0._classes.changed[className] = true;
    }));
    this._dirty = true;
    return this;
  },
